      ...
      >
        <Card className="p-6 sm:p-8 border-white/40 shadow-2xl rounded-3xl bg-white/90 backdrop-blur-md">
          <CardHeader className="flex flex-col items-center mb-6 space-y-2">
            ...
            <h1 className="text-2xl font-black font-poppins text-gray-800 tracking-tight text-center">Seja um Parceiro</h1>
          ...
          <CardContent>
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="flex items-start gap-3 p-4 bg-gray-50/80 rounded-2xl border border-gray-200 mt-2">
                <input 
                  type="checkbox" 
                  id="terms"
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9, y: 20 }} className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[80vh] flex flex-col">
              ...
              <div className="p-8 overflow-y-auto scrollbar-hide text-gray-600 space-y-4 text-sm leading-relaxed">
                <div className="space-y-6">
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">1. QUEM PODE PARTICIPAR</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">2. COMO FUNCIONA</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">3. BENEFÍCIOS</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">4. VALIDADE DA COMISSÃO</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">5. CANCELAMENTO E CHURN</h3>
                    <p>Se o indicado cancelar, a comissão cessa imediatamente. Não há comissão proporcional para cancelamentos no meio do mês.</p>
                  </section>

                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">6. PAGAMENTO</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">7. REGRAS ANTIFRAUDE</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">8. PROPRIEDADE DO CLIENTE</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">9. NATUREZA E ENCERRAMENTO</h3>
                  ...
                  <section>
                    <h3 className="font-black text-gray-800 mb-2 uppercase text-xs tracking-widest">10. ALTERAÇÕES</h3>
