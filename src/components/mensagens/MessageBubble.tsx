...
/**
 * Determina o tipo de bolha:
 *  - "ai"       → outbound, source = "ai"   → bolha roxa/violeta com ícone Bot
 *  - "agent"    → outbound, source != "ai"  → bolha azul primária (atendente)
 *  - "customer" → inbound                   → bolha cinza clara (paciente)
 */
